      ...
      <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: CREAM, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif', fontSize: baseFontSize }}>
        ...
        <main style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          {/* ── Mobile/tablet topbar ──────────────────────────────────────────
              Sticky header shown only when the sidebar is in overlay mode.
              Contains the hamburger button to open the drawer and the current
              section label so the user always knows where they are.         */}
          {isOverlay && (
            <div style={{
