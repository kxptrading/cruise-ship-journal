// ─────────────────────────────────────────────────────────────────────────────
// components/AuthScreen.tsx — Login and sign-up screen
// ─────────────────────────────────────────────────────────────────────────────
              ...
              <>
                  ...
                  <>
                    <div style={{ display: 'flex', gap: 12, marginBottom: 16 }}>
                      <div style={{ flex: 1 }}>
                        ...
                        <input value={firstName} onChange={e => setFirstName(e.target.value)} placeholder="Kiran" required autoComplete="given-name" style={inp} />
                      </div>
                      <div style={{ flex: 1 }}>
                        ...
                        <input value={lastName} onChange={e => setLastName(e.target.value)} placeholder="Parmar" required autoComplete="family-name" style={inp} />
                      </div>
                    </div>
                    <div style={{ marginBottom: 16 }}>
                      ...
                      <input type="number" value={age} onChange={e => setAge(e.target.value)} placeholder="e.g. 34" required min="1" max="120" style={inp} />
                    </div>
                  </>
                )}
                <div style={{ marginBottom: 16 }}>
                ...
                {!isReset && (
                  <div style={{ marginBottom: isSignUp ? 16 : 8 }}>
                    ...
                    <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" required autoComplete={isSignUp ? 'new-password' : 'current-password'} style={inp} />
                  </div>
                )}
                {!isReset && !isSignUp && (
                ...
                {isSignUp && (
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input type="password" value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="••••••••" required autoComplete="new-password" style={inp} />
                  </div>
                )}
                {error && (
